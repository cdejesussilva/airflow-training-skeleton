...
spark.read.json(
    "gs://airflow-training-catia/land_registry_price_paid_uk/*/*.json"
).withColumn(
...
spark.read.json("gs://airflow-training-catia/currency/*.json").withColumn(
...
(
    ...
    .parquet("gs://airflow-training-catia/average_prices/")
)
